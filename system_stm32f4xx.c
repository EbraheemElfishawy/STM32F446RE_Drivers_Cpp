...
#define SRAM_SIZE	(128*1024) //for f103 (20*1024)
#define SRAM_END	(SRAM_START) + SRAM_SIZE
#define STACK_START	SRAM_END
extern uint32_t _etext;	// end   of .text section in FLASH(start of .data section in FLASH)
...
void Reset_Handler(void)
{
	...
	//2- Initialise .bss section to zero
	pSrc  = (uint8_t*)&_sbss;
